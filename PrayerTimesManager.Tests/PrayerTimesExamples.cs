...
public static class PrayerTimesExamples
{
    ...
    {
        Console.WriteLine("=== Now and Tomorrow (typed results) ===");

        var prayerTimes = new PrayerTimes();
        PrayerTimesResult today = prayerTimes.NowResult(51.5074, -0.1278, TimeZoneInfo.Utc);
        PrayerTimesResult tomorrow = prayerTimes.TomorrowResult(51.5074, -0.1278, TimeZoneInfo.Utc);
